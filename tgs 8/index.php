...
<body>
    ...
    <section id="product" class="product-categories">
        ...
        <!-- Produk 1 -->
        <div class="category">
            <a href="cekout.php" onclick="showSnackbar('Anda baru saja melihat paket outdoor 1'); return false;">
        ...
        <!-- Produk 2 -->
        <div class="category">
            <a href="cekout.php" onclick="showSnackbar('Anda baru saja melihat paket outdoor 2'); return false;">
